...
<Headers/>
  <div class="editor-container">
    ...
    <Tooltip style="zoom:0.8;top:100px;left:50px" class="backhome" content="强制回到上一页" placement="top-start">
    <Button style="zoom:1.4" @click="modal = true" shape="circle" icon="md-backspace"></Button></Tooltip>
